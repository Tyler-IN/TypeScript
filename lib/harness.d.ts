...
declare namespace vfs {
    ...
    class FileSystem {
         ...
         */
        diff(base?: FileSystem | undefined): FileSet | undefined;
        /**
         * Generates a `FileSet` patch containing all the entries in `chagned` that are not in `base`.
         */
        static diff(changed: FileSystem, base: FileSystem): FileSet | undefined;
...
declare namespace Harness {
    ...
    namespace Compiler {
        ...
        function compileFiles(inputFiles: TestFile[], otherFiles: TestFile[], harnessSettings: TestCaseParser.CompilerSettings | undefined, compilerOptions: ts.CompilerOptions | undefined, currentDirectory: string | undefined, symlinks?: vfs.FileSet): compiler.CompilationResult;
        ...
        function compileDeclarationFiles(context: DeclarationCompilationContext | undefined, symlinks: vfs.FileSet | undefined): {
            declInputFiles: TestFile[];
            declOtherFiles: TestFile[];
...
declare namespace FourSlash {
    ...
    class TestState {
        ...
        verifyGetEmitOutput(expectedOutputFiles: ReadonlyArray<string>): void;
        ...
        verifyNavigateTo(options: ReadonlyArray<FourSlashInterface.VerifyNavigateToOptions>): void;
