...
(function (vfs) {
    ...
    var FileSystem = /** @class */ (function () {
         ...
         */
        FileSystem.prototype.diff = function (base) {
            if (base === void 0) { base = this.shadowRoot; }
            var differences = {};
            var hasDifferences = base ? FileSystem.rootDiff(differences, this, base) : FileSystem.trackCreatedInodes(differences, this, this._getRootLinks());
         ...
         */
        FileSystem.diff = function (changed, base) {
            var differences = {};
            return FileSystem.rootDiff(differences, changed, base) ? differences : undefined;
        };
        FileSystem.diffWorker = function (container, changed, changedLinks, base, baseLinks) {
                ...
                changedLinks.forEach(function (changedNode, basename) {
                    ...
                    if (baseNode) {
                        if (isDirectory(changedNode) && isDirectory(baseNode)) {
                            return hasChanges_1 = FileSystem.directoryDiff(container, basename, changed, changedNode, base, baseNode) || hasChanges_1;
                        }
                        if (isFile(changedNode) && isFile(baseNode)) {
                            return hasChanges_1 = FileSystem.fileDiff(container, basename, changed, changedNode, base, baseNode) || hasChanges_1;
                        }
        ...
        FileSystem.rootDiff = function (container, changed, base) {
        ...
        FileSystem.directoryDiff = function (container, basename, changed, changedNode, base, baseNode) {
        ...
        FileSystem.fileDiff = function (container, basename, changed, changedNode, base, baseNode) {
    ...
    (function (server) {
        ...
        var SessionClient = /** @class */ (function () {
            ...
            SessionClient.prototype.getDefinitionAndBoundSpan = function (fileName, position) {
                ...
                var response = this.processResponse(request);
                var body = ts.Debug.assertDefined(response.body); // TODO: GH#18217
                return {
...
(function (Harness) {
    ...
    (function (Compiler) {
        ...
        function iterateErrorBaseline(inputFiles, diagnostics, options) {
            ...
            var outputLines, totalErrorsReportedInNonLibraryFiles, errorsReported, firstLine, formatDiagnsoticHost, globalErrors, dupeCase, _loop_1, _i, _a, inputFile, numLibraryDiagnostics, numTest262HarnessDiagnostics;
...
(function (ts) {
    ...
    (function (TestFSWithWatch) {
        ...
        var TestServerHost = /** @class */ (function () {
            ...
            TestServerHost.prototype.removeFile = function (filePath) {
                var path = this.toFullPath(filePath);
                var currentEntry = this.fs.get(path);
    ...
    var TestState = /** @class */ (function () {
        ...
        TestState.prototype.verifyGoToXWorker = function (endMarkers, getDefs, startMarkerName) {
            ...
            ts.zipWith(endMarkers, definitions, function (endMarker, definition, i) {
                ...
                if (ts.comparePaths(marker.fileName, definition.fileName, /*ignoreCase*/ true) !== 0 /* EqualTo */ || marker.position !== definition.textSpan.start) {
        ...
        TestState.prototype.verifyCompletionsWorker = function (options) {
            ...
            if (!actualCompletions) {
                if ("exact" in options && options.exact === undefined)
                    return;
        ...
        TestState.prototype.verifySignatureHelpWorker = function (options) {
            ...
            ts.zipWith((options.tags || ts.emptyArray), actualTags, function (expectedTag, actualTag) {
                assert.equal(actualTag.name, expectedTag.name);
                assert.equal(actualTag.text, expectedTag.text, _this.assertionMessageAtLastKnownMarker("signature help tag " + actualTag.name));
            });
            var allKeys = [
                "marker",
                "triggerReason",
        ...
        TestState.prototype.baselineGetEmitOutput = function () {
            var _this = this;
            Harness.Baseline.runBaseline(ts.Debug.assertDefined(this.testData.globalOptions["BaselineFile" /* baselineFile */]), function () {
                var resultString = "";
                // Loop through all the emittedFiles and emit them one by one
                for (var _i = 0, _a = _this.getEmitFiles(); _i < _a.length; _i++) {
                    var emitFile = _a[_i];
        ...
        TestState.prototype.verifyFormatDocumentChangesNothing = function () {
            ...
            this.formatDocument();
            var after = this.getFileContent(fileName);
        ...
        TestState.prototype.verifyImportFixAtPosition = function (expectedTextArray, errorCode, preferences) {
            ...
            var codeFixes = this.getCodeFixes(fileName, errorCode, preferences).filter(function (f) { return f.fixId === ts.codefix.importFixId; });
        ...
        TestState.prototype.verifyRefactorAvailable = function (negative, name, actionName) {
            var refactors = this.getApplicableRefactorsAtSelection();
        ...
        TestState.prototype.getApplicableRefactorsAtSelection = function () {
            return this.getApplicableRefactorsWorker(this.getSelection(), this.activeFile.fileName);
        };
        TestState.prototype.getApplicableRefactors = function (rangeOrMarker, preferences) {
            if (preferences === void 0) { preferences = ts.emptyOptions; }
        ...
        TestState.prototype.getApplicableRefactorsWorker = function (positionOrRange, fileName, preferences) {
            if (preferences === void 0) { preferences = ts.emptyOptions; }
...
var TypeWriterWalker = /** @class */ (function () {
    ...
    TypeWriterWalker.prototype.writeTypeOrSymbol = function (node, isSymbolWalk) {
        ...
        if (!isSymbolWalk) {
            ...
            if (ts.isPartOfTypeNode(node) || ts.isIdentifier(node) && !(ts.getMeaningFromDeclaration(node.parent) & 1 /* Value */) && !(ts.isTypeAlias(node.parent) && node.parent.name === node)) {
                return undefined;
            }
            ...
            var typeString = this.checker.typeToString(type, node.parent, 1 /* NoTruncation */ | 1048576 /* AllowUniqueESSymbolType */);
            return {
