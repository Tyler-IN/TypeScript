    ...
    (function (server) {
        var TextStorage = (function () {
            ...
            TextStorage.prototype.getFileText = function (tempFileName) {
                var _this = this;
                var text;
                var getText = function () { return text === undefined ? (text = _this.host.readFile(tempFileName || _this.fileName) || "") : text; };
                var size = this.host.getFileSize ? this.host.getFileSize(tempFileName || this.fileName) : getText().length;
                return size > server.maxFileSize ? "" : getText();
            };
    ...
    (function (server) {
        ...
        var ProjectService = (function () {
            ...
            ProjectService.prototype.convertConfigFileContentToProjectOptions = function (configFilename, cachedDirectoryStructureHost) {
                ...
                var parsedCommandLine = ts.parseJsonSourceFileConfigFileContent(result, cachedDirectoryStructureHost, ts.getDirectoryPath(configFilename), {}, configFilename, [], this.hostConfiguration.extraFileExtensions);
            ...
            Session.prototype.defaultEventHandler = function (event) {
                switch (event.eventName) {
                    ...
                    case server.ConfigFileDiagEvent:
                        var _a = event.data, triggerFile = _a.triggerFile, configFile = _a.configFileName, diagnostics = _a.diagnostics;
