...
declare namespace ts {
    ...
    const enum TypeFlags {
        ...
        UnionOfPrimitiveTypes = 67108864,
...
declare namespace ts {
    const Diagnostics: {
        ...
        Option_resolveJsonModule_can_only_be_specified_when_module_code_generation_is_commonjs: DiagnosticMessage;
...
declare namespace ts.moduleSpecifiers {
    ...
    function getModuleSpecifier(compilerOptions: CompilerOptions, importingSourceFile: SourceFile, importingSourceFileName: Path, toFileName: string, host: ModuleSpecifierResolutionHost, files: ReadonlyArray<SourceFile>, preferences: ModuleSpecifierPreferences | undefined, redirectTargetsMap: RedirectTargetsMap): string;
    function getModuleSpecifierForDeclarationFile(moduleSymbol: Symbol, compilerOptions: CompilerOptions, importingSourceFile: SourceFile, host: ModuleSpecifierResolutionHost, redirectTargetsMap: RedirectTargetsMap): string;
    function getModuleSpecifiers(moduleSymbol: Symbol, compilerOptions: CompilerOptions, importingSourceFile: SourceFile, host: ModuleSpecifierResolutionHost, files: ReadonlyArray<SourceFile>, preferences: ModuleSpecifierPreferences, redirectTargetsMap: RedirectTargetsMap): ReadonlyArray<ReadonlyArray<string>>;
}
declare namespace ts {
    /**
...
declare namespace ts {
    ...
    function getSynthesizedDeepCloneWithRenames<T extends Node | undefined>(node: T, includeTrivia?: boolean, renameMap?: Map<Identifier>, checker?: TypeChecker, callback?: (originalNode: Node, clone: Node) => any): T;
...
declare namespace ts {
    ...
    /** @internal */
    function getReturnStatementsWithPromiseHandlers(node: Node): Node[];
}
...
declare namespace ts.codefix {
    ...
    function createMethodFromCallExpression(context: CodeFixContextBase, { typeArguments, arguments: args, parent: parent }: CallExpression, methodName: string, inJs: boolean, makeStatic: boolean, preferences: UserPreferences, body: boolean): MethodDeclaration;
}
declare namespace ts.codefix {
}
declare namespace ts.codefix {
